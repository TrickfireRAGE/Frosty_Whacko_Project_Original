...
if (room == rm_shopSounds)
{
	...
	if (global.fishWallet >= 300 || obj_coreGame.endlessTrackFate == true)
	{
		...
		if (!(instance_exists(obj_shopFateConfirmButton)) && !(obj_coreGame.endlessTrackSelection == enumEndlessTracks.yourFateIsSealed))
		{
	...
	if (global.fishWallet >= 150 || obj_coreGame.endlessTrackRight == true)
	{
		instance_create_layer(287, 110, "Shop_Instances", obj_shopRightPlayButton, {image_xscale: 0.8, image_yscale: 0.8});
		draw_text_transformed_colour(325, 112, "Right to Polar" + "\nBear Arms", 0.5, 0.5, 0, c_red, c_orange, c_fuchsia, c_red, 1);
		switch(obj_coreGame.endlessTrackRight)
		{
			case(true):
		...
		if (!(instance_exists(obj_shopRightConfirmButton)) && !(obj_coreGame.endlessTrackSelection == enumEndlessTracks.rightToPolarBearArms))
		{
	...
	switch(obj_coreGame.endlessTrackWrong)
	{
		case(true):
	...
	if (!(instance_exists(obj_shopWrongConfirmButton)) && !(obj_coreGame.endlessTrackSelection == enumEndlessTracks.wrongToPolarBearArms))
	{
	...
	if (global.fishWallet >= 500 || obj_coreGame.endlessTrackBeyond == true)
	{
		instance_create_layer(287, 215, "Shop_Instances", obj_shopBeyondPlayButton, {image_xscale: 0.8, image_yscale: 0.8});
		draw_text_transformed_colour(325, 217, "'Beyond'" + "\nGekido's Theme", 0.45, 0.45, 0, c_red, c_orange, c_fuchsia, c_red, 1);
		switch(obj_coreGame.endlessTrackBeyond)
		{
			case(true):
		...
		if (!(instance_exists(obj_shopBeyondConfirmButton)) && !(obj_coreGame.endlessTrackSelection == enumEndlessTracks.beyondGekidoTheme))
		{
