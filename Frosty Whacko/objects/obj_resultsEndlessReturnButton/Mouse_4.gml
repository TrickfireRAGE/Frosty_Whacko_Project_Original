...
switch(global.userName)
{
	case (1):
		...
		var _score = ini_read_real("User_One_Score", "Level_Endless", 0);
		if (_score < _levelScore)
		{
			ini_write_real("User_One_Score", "Level_Endless", _levelScore);
		}
		ini_close();
		break;
	case (2):
		...
		var _score = ini_read_real("User_Two_Score", "Level_Endless", 0);
		if (_score < _levelScore)
		{
			ini_write_real("User_Two_Score", "Level_Endless", _levelScore);
		}
		ini_close();
		break;
	case (3):
		...
		var _score = ini_read_real("User_Three_Score", "Level_Endless", 0);
		if (_score < _levelScore)
		{
			ini_write_real("User_Three_Score", "Level_Endless", _levelScore);
		}
		ini_close();
		break;
}		
